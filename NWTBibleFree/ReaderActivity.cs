    ...
    public class ReaderActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            if (ThisApp.ReaderKind == ReaderKind.BibleReader)
            {
                ...
                Title = "New World Translation — " + ThisApp.selectedChapter.BookAndChapter;
                LoadBibleReader();
            }
        ...
        public class MyWebViewClient : WebViewClient
        {
            ...
            public override void OnPageFinished(WebView webview, string url)
            {
                ...
                {
                    //_context.Title = "New World Translation — " + ThisApp.selectedChapter.BookAndChapter;
                    //_context.Title = "New World Translation of the Holy Scriptures"; 
                }
