...
namespace NWTBibleFree
{
    public class App : Application
    {
        ...
        public List<string> FileDownloadList()
        {
            List<string> files = new List<string>();

            string[] books = GetAllBookNames();
            string[] others = {"hebrew", "greek", "dailytext"};
            var all = ConcatArrays(books, others);
        ...
        public string[] GetAvailableLanguages()
        {
            ...
            foreach (String lang in doc.Descendants("language"))
            {
                if (!lang.Equals("Chinese Simplified Pinyin"))
                {
                    languages.Add(lang);
                }
            }
