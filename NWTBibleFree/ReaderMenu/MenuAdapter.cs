...
namespace NWTBibleFree.ReaderMenu
{
    ...
    public class MenuAdapter : BaseAdapter<string>
    {
            ...
            : base()
        {
            ...
            {
                headers.Add(section);
                sections.Add(section, new ArrayAdapter<string>(context, Android.Resource.Layout.SimpleListItem1, samples[section]));
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            //view.FindViewById<TextView>(Android.Resource.Id.Text1).Text = ((string)item);
            view.FindViewById<TextView>(Android.Resource.Id.Text1).SetTypeface(Typeface.CreateFromAsset(context.Assets, "fonts/Ion-Bold.ttf"), Android.Graphics.TypefaceStyle.Bold);
