...
{
    [Activity(Label = "New World Translation of the Holy Scriptures")]
    public class ReaderSliderActivity : SlidingFragmentActivity, ActionbarSherlock.App.ActionBar.IOnNavigationListener
    {
        ...
        public override void OnCreate(Bundle savedInstanceState)
        {
            ...
            else if (ThisApp.ReaderKind == ReaderKind.DailyTextReader)
            {
                ...
                Title = "New World Translation — " + ThisApp.selectedDailyText.Date;
            }
        ...
        {
            var actionitem1 = menu.Add(0, 7, 7, "<< Prev");
            ...
            {
                var actionitem4 = menu.Add(0, 8, 8, "Today");
