...
namespace StickyGridHeaders {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.tonicartos.widget.stickygridheaders']/interface[@name='StickyGridHeadersSimpleAdapter']"
	[Register ("com/tonicartos/widget/stickygridheaders/StickyGridHeadersSimpleAdapter", "", "StickyGridHeaders.IStickyGridHeadersSimpleAdapterInvoker")]
	public partial interface IStickyGridHeadersSimpleAdapter : global::Android.Widget.IListAdapter {

		// Metadata.xml XPath method reference: path="/api/package[@name='com.tonicartos.widget.stickygridheaders']/interface[@name='StickyGridHeadersSimpleAdapter']/method[@name='getHeaderId' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("getHeaderId", "(I)J", "GetGetHeaderId_IHandler:StickyGridHeaders.IStickyGridHeadersSimpleAdapterInvoker, StickyGridHeadersBinding")]
		long GetHeaderId (int p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.tonicartos.widget.stickygridheaders']/interface[@name='StickyGridHeadersSimpleAdapter']/method[@name='getHeaderView' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.view.ViewGroup']]"
		[Register ("getHeaderView", "(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;", "GetGetHeaderView_ILandroid_view_View_Landroid_view_ViewGroup_Handler:StickyGridHeaders.IStickyGridHeadersSimpleAdapterInvoker, StickyGridHeadersBinding")]
		global::Android.Views.View GetHeaderView (int p0, global::Android.Views.View p1, global::Android.Views.ViewGroup p2);

	}

	[global::Android.Runtime.Register ("com/tonicartos/widget/stickygridheaders/StickyGridHeadersSimpleAdapter", DoNotGenerateAcw=true)]
	internal class IStickyGridHeadersSimpleAdapterInvoker : global::Java.Lang.Object, IStickyGridHeadersSimpleAdapter {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/tonicartos/widget/stickygridheaders/StickyGridHeadersSimpleAdapter");
		IntPtr class_ref;

		public static IStickyGridHeadersSimpleAdapter GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IStickyGridHeadersSimpleAdapter> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.tonicartos.widget.stickygridheaders.StickyGridHeadersSimpleAdapter"));
			return handle;
		}
		...
		public IStickyGridHeadersSimpleAdapterInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		protected override System.Type ThresholdType {
			get { return typeof (IStickyGridHeadersSimpleAdapterInvoker); }
		}
...
#pragma warning disable 0169
		...
		{
			global::StickyGridHeaders.IStickyGridHeadersSimpleAdapter __this = global::Java.Lang.Object.GetObject<global::StickyGridHeaders.IStickyGridHeadersSimpleAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetHeaderId (p0);
		}
#pragma warning restore 0169

		IntPtr id_getHeaderId_I;
		public long GetHeaderId (int p0)
		{
