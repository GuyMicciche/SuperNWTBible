	...
	public partial class StickyGridHeadersSimpleArrayAdapter : global::Android.Widget.BaseAdapter, global::StickyGridHeaders.IStickyGridHeadersSimpleAdapter {
		...
		protected internal partial class HeaderViewHolder : global::Java.Lang.Object {
			...
			protected HeaderViewHolder (global::StickyGridHeaders.StickyGridHeadersSimpleArrayAdapter __self) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				...
				SetHandle (JNIEnv.NewObject (class_ref, id_ctor_Lcom_tonicartos_widget_stickygridheaders_StickyGridHeadersSimpleArrayAdapter_, new JValue (__self)), JniHandleOwnership.TransferLocalRef);
			}
		...
		public StickyGridHeadersSimpleArrayAdapter (global::Android.Content.Context p0, global::Java.Lang.Object[] p1, int p2, int p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (StickyGridHeadersSimpleArrayAdapter)) {
				SetHandle (global::Android.Runtime.JNIEnv.CreateInstance (GetType (), "(Landroid/content/Context;[Ljava/lang/Object;II)V", new JValue (p0), new JValue (native_p1), new JValue (p2), new JValue (p3)), JniHandleOwnership.TransferLocalRef);
				if (p1 != null) {
			...
			SetHandle (JNIEnv.NewObject (class_ref, id_ctor_Landroid_content_Context_arrayLjava_lang_Object_II, new JValue (p0), new JValue (native_p1), new JValue (p2), new JValue (p3)), JniHandleOwnership.TransferLocalRef);
			if (p1 != null) {
				JNIEnv.CopyArray (native_p1, p1);
				JNIEnv.DeleteLocalRef (native_p1);
			}
		...
		public StickyGridHeadersSimpleArrayAdapter (global::Android.Content.Context p0, global::System.Collections.IList p1, int p2, int p3) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			if (GetType () != typeof (StickyGridHeadersSimpleArrayAdapter)) {
				SetHandle (global::Android.Runtime.JNIEnv.CreateInstance (GetType (), "(Landroid/content/Context;Ljava/util/List;II)V", new JValue (p0), new JValue (Java.Interop.JavaObjectExtensions.ToInteroperableCollection (p1)), new JValue (p2), new JValue (p3)), JniHandleOwnership.TransferLocalRef);
				JNIEnv.DeleteLocalRef (native_p1);
				return;
			}
			...
			SetHandle (JNIEnv.NewObject (class_ref, id_ctor_Landroid_content_Context_Ljava_util_List_II, new JValue (p0), new JValue (Java.Interop.JavaObjectExtensions.ToInteroperableCollection (p1)), new JValue (p2), new JValue (p3)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p1);
		}
...
#pragma warning disable 0169
		...
		{
			global::StickyGridHeaders.StickyGridHeadersSimpleArrayAdapter __this = global::Java.Lang.Object.GetObject<global::StickyGridHeaders.StickyGridHeadersSimpleArrayAdapter> (native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Count;
		}
...
#pragma warning restore 0169
		...
		public override global::Java.Lang.Object GetItem (int p0)
		{
			...
			if (GetType () == ThresholdType)
				...
				return (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, id_getItem_I, new JValue (p0)), JniHandleOwnership.TransferLocalRef);
		}
