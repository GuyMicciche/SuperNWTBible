...
namespace NWTBible.ReaderMenu
{
    ...
    public class ReaderActivity : SlidingFragmentActivity, ActionBar.IOnNavigationListener, SlidingMenu.IOnOpenedListener
    {
        ...
        public void InitializeActionBarItemList()
        {
            ...
            else if (ThisApp.ReaderKind == ReaderKind.BibleReader)
            {
                ...
                for (var i = 0; i < chapters.Length; i++)
                {
                    ...
                    chapters[i] = ThisApp.selectedBook.Title + " " + (i + 1).ToString();
                }
        ...
        public override bool OnCreateOptionsMenu(Xamarin.ActionbarSherlockBinding.Views.IMenu menu)
        {
            ...
            if (ThisApp.preferences.GetString("listSecondLanguage", ThisApp.Language) == "Chinese Simplified Pinyin" || ThisApp.Language == "Chinese Simplified Pinyin")
            {
                var pinyinMenu = menu.Add(0, PINYIN_MENU, PINYIN_MENU, "Pinyin");
                pinyinMenu.SetShowAsAction((int)ShowAsAction.WithText);
            }
        ...
        private const int PINYIN_MENU = 10;
        ...
        public override bool OnOptionsItemSelected(Xamarin.ActionbarSherlockBinding.Views.IMenuItem item)
        {
            ...
            switch (item.ItemId)
            {
                ...
                case (TODAY_MENU):
                    ...
                    return true;
                case (PINYIN_MENU):
                    ThisApp.PinyinToggle = reader.TogglePinyin(ThisApp.PinyinToggle);
                    return true;                
            }
